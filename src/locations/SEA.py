...
This code contains the location class for Seattle, WA,
or "SEA." SEA is a subclass of the Location abstract class. 
"""
...
class SEA(Location):
    """
    Class object for Seattle, WA. Subclass of the Location
    abstract class.
    """
    def __init__(self):
        """
