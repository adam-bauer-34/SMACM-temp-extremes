...
This code contains the location class for Atlanta, GA,
or "ATL." ATL is a subclass of the Location abstract class. 
"""
...
class ATL(Location):
    """
    Class object for Atlanta, GA. Subclass of the Location
    abstract class.
    """
    def __init__(self):
        """
