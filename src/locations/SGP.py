...
This code contains the location class for the Southern Great Plains,
or "SGP." SGP is a subclass of the Location abstract class. 
"""
...
class SGP(Location):
    """
    Class object for the Southern Great Plains (SGP). Subclass of the Location
    abstract class; see above.
    """
    def __init__(self):
